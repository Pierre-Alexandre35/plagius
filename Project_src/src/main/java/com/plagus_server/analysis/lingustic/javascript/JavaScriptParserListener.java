package com.plagus_server.analysis.lingustic.javascript;
...
public interface JavaScriptParserListener extends ParseTreeListener {
   ...
   * in {@link JavaScriptParser#propertyAssignment}.
   *
   * @param ctx the parse tree
   */
   ...
   * in {@link JavaScriptParser#singleExpression}.
   *
   * @param ctx the parse tree
   */
   ...
   * JavaScriptParser#anoymousFunction}.
   *
   * @param ctx the parse tree
   */
